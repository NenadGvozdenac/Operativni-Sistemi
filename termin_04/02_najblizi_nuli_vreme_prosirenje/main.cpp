...
int main() {
    ...
    for(int i = 0; i < BROJ_NITI; i++) {
        duration<double, nano> trajanje = vremena[i].kraj - vremena[i].pocetak;
        cout << "Trajanje niti[" << i << "] je: " << trajanje.count() << " nanosekundi." << endl;
        duration<double, milli> trajanjeMilli = vremena[i].kraj - vremena[i].pocetak;
        cout << "Trajanje niti[" << i << "] je: " << trajanjeMilli.count() << " milisekundi." << endl;
        duration<double> trajanjeSekunde = vremena[i].kraj - vremena[i].pocetak;
        cout << "Trajanje niti[" << i << "] je: " << trajanjeSekunde.count() << " sekundi." << endl;
        duration<double, ratio<60>> trajanjeMinute = vremena[i].kraj - vremena[i].pocetak;
        cout << "Trajanje niti[" << i << "] je: " << trajanjeMinute.count() << " minuti." << endl << endl;
    }
